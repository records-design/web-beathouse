...
(function () {
  ...
  function setFeatured(thumb) {
    ...
    setTimeout(function () {
      ...
      if (featSocials) {
        var html = ''
        if (thumb.dataset.instagram) {
          html += '<a href="https://instagram.com/' + thumb.dataset.instagram + '" target="_blank" rel="noopener" class="feat-social-btn feat-social-ig">' + SVG_IG + ' Instagram</a>'
        }
        if (thumb.dataset.spotify) {
          html += '<a href="https://open.spotify.com/artist/' + thumb.dataset.spotify + '" target="_blank" rel="noopener" class="feat-social-btn feat-social-sp">' + SVG_SP + ' Spotify</a>'
        }
